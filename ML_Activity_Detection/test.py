...
parser.add_argument('-model', type=str, default='P02T01C06')
parser.add_argument('-APtype', type=str, default='wap')
parser.add_argument('-randomseed', type=str, default='False')
parser.add_argument('-load_model', type=str, default='/content/drive/MyDrive/Colab/ICT3104/PDAN_TSU_RGB')
...
if args.dataset == 'TSU':
    ...
    if split_setting == 'CS':
        train_split = r"/content/drive/MyDrive/Colab/ICT3104/smarthome_CS_51.json"
        # train_split = x[:80]
        # test_split = './data/smarthome_CS_51.json'
        test_split = r"/content/drive/MyDrive/Colab/ICT3104/smarthome_CS_51.json"
        # test_split = y[80:]
    ...
    rgb_root = r"/content/drive/MyDrive/Colab/ICT3104/RGB_i3d_16frames_64000_SSD"
...
def run(models, criterion, num_epochs=50):
    ...
    for epoch in range(num_epochs):
        ...
        for model, gpu, dataloader, optimizer, sched, model_file in models:
            ...
            filepath = r'/content/drive/MyDrive/Colab/ICT3104/PDAN_TEST'
            # value = 10
            if best_map < val_map:
                best_map = val_map
                # best_map = value
                torch.save(model.state_dict(),
                            filepath + str(args.model) + '/weight_epoch_' + str(args.lr) + '_' + str(epoch))
                torch.save(model, filepath + str(args.model) + '/model_epoch_' + str(args.lr) + '_' + str(epoch))
                print('save here:', filepath + str(args.model) + '/weight_epoch_' + str(args.lr) + '_' + str(epoch))
...
if __name__ == '__main__':
    ...
    if args.train is False:
        ...
        # print(len(inputs)) #4
        eval_model(model,dataloaders['val'],baseline=False)
